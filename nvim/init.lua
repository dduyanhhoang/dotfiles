-- Neovim config -- kickstart.nvim (github.com/nvim-lua/kickstart.nvim), personalised.
-- Platform differences are runtime `vim.fn.has 'win32'` branches, never separate files.
-- Plugin versions are pinned in nvim-pack-lock.json (`:help vim.pack-lockfile`).
...
do
  ...
  require('telescope').setup {
    ...
    pickers = {
      find_files = { hidden = true, no_ignore = true, file_ignore_patterns = { '^%.git/', '/%.git/' } },
    },
    extensions = {
...
-- Own plugins: lua/custom/plugins/*.lua
